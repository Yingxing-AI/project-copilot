...
## Changes since v0.3.0-alpha.5

- 8bb0a1e docs: record sprint validation worklog
- 263327d docs: start sprint validation case study
- cd51ea2 docs: add project promo image
- 22e0310 fix: generate release notes from tag changes
