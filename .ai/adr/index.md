...
说明：ADR 记录三个月后仍重要的架构、产品范围和长期取舍，重点回答“为什么这样做”。

- [ADR 0001: 收敛为 Codex 项目记忆层](0001-codex-project-memory-layer.md)
- [ADR 0002: 使用 Session Memory 写入模型](0002-session-memory-model.md)
